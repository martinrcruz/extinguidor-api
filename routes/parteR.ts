 ...
 */
parteRoutes.get('/contrato/:contrato', verificarToken, async (req: Request, res: Response) => {
 ...
 */
parteRoutes.get('/ruta/:ruta', verificarToken, async (req: Request, res: Response) => {
